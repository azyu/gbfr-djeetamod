...
- 화면 해상도:
- 파티 구성:
- NSIS installer SHA-256: `EAEA1FEE468870B57A4CFD88672BF51BD367862D0FAC9A865F19491609B5B1AA`
- `hook.dll` SHA-256: `AE18581692694DC4F867ABF887E8016CEFBEB29FD42DBD743DECAAEF4C7B8DA6`
- 훅 로그 경로:
- 테스트 일시:
