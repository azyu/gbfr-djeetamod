...
- 화면 해상도:
- 파티 구성:
- NSIS installer SHA-256: `20B7863309323BBE4BFA8EF0B7B5D6ABC40C1551FD228C6245C6E6DF95C7303B`
- `hook.dll` SHA-256: `8771D546840386CEA82238CE2AE7C01BCC3DD131ED8297C9E90D15DA4EB8B7CB`
- 훅 로그 경로:
- 테스트 일시:
...
if ($versions.Count -ne 1 -or $versions[0] -ne '0.1.6') { throw 'Version mismatch or unexpected release version' }
```
