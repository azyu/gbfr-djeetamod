...
- 화면 해상도:
- 파티 구성:
- NSIS installer SHA-256: `C0C1539E9505C82C43BA5210955AD9661883DF235466A9E65695C22691664F7E`
- `hook.dll` SHA-256: `5E759D8B1FF75E33F618B7FC1AAA12C1B88080AF8AC793A67AF2A9DD96641627`
- 훅 로그 경로:
- 테스트 일시:
